          ...
          <Card className="border-border bg-card">
            <CardHeader className="text-center space-y-1">
              ...
              <CardDescription className="text-body">
                Join ScriptSlap and start creating viral scripts with AI
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleEmailSignUp} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <PasswordStrengthChecker password={password} className="mt-3" />
                </div>

                <Button
                  type="submit"
                  className="w-full"
                  disabled={loading || !email || !isPasswordStrong(password)}
                  size="lg"
                >
